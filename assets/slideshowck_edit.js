function ckSaveSlideshow() {
	...
	if (jQuery('#ckslides').length && jQuery('#slides_sources').val() == 'slidemanager') {
		...
		jQuery('#ckslides .ckslide').each(function(i, slide) {
			...
			slide_obj.title = jQuery('.ckslidetitle', slide).val().replace(regex, "");
			slide_obj.title = slide_obj.title.replace(/"/g, "|dq|");
			slide_obj.description = jQuery('.ckslidedescription', slide).val().replace(regex, "");
...
//			slide_obj.imgthumb = jQuery('img', slide).src;
			...
			slide_obj.state = jQuery('.ckslidetoggle', slide).attr('data-state');
...
jQuery(document).ready(function(){
	...
	jQuery('.ckslidetoggle').click(function() {
